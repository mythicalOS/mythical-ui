...
// checks — 6c50c90's packages/ui-core/test/styles-comments.test.ts is SUPERSEDED by this file
// rather than left to run alongside it, and its checks now cover shell and the embedded select
// sheet too, which they never did.
//
