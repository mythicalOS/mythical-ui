...
#      tokens.css + its fonts live in the SIBLING mythical-design checkout — the same
#      sibling-checkout resolution packages/ui-core/test/css.test.ts
...
d = pathlib.Path('.')
# sibling checkout: tokens.css + the fonts it references no
