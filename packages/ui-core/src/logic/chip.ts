...
// `Tag` concept. This module is the single home of the whole family, INCLUDING `chipClass`, which
// used to live in `tone.ts`; a second derivation of a chip's class string is exactly the drift
