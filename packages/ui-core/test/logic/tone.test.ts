...
//
// `chipClass` is NOT tested here. The whole chip family lives in src/logic/chip.ts and its
// coverage lives beside it — see test/logic/chip.test.ts. This file must not re-derive a chip class: one
