// packages/react-ui/kpi-tile.test.tsx — render contracts for KpiTile (ds/components-kpi-tile).
// React twin of packages/preact-ui/kpi-tile.test.tsx. Pure geometry/tone math is covered in
// ui-core's test/logic/kpi-tile.test.ts; this file asserts the markup grammar and the CSP/honesty
// behavior rules the component implements. Expected class strings are derived by importing the
// CORE functions/constants directly, never hard-coded, so the binding and `@mythicalos/ui-core`
...
function tile(props: KpiTileProps): string {
  return renderToStaticMarkup(<KpiTile {...props} />);
}
