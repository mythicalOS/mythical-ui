...
// SearchInput, Banner, Gauge). Serve `@mythicalos/ui-core/styles.css` (after
...
// ── the 7 new atoms (design-export's "proposed additions") ──
...
// the rich-row derivation — consumed straight from core; the packaged Popover
// keeps rendering the plain single-line menu rows
export { popItemClass } from "@mythicalos/ui-core/logic";

// ── stepper · seg · callout + help opener ──
export {
  Stepper,
  STEPPER_PARTS,
  STEP_DONE_GLYPH,
