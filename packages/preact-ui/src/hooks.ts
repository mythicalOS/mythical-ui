...
// request/response to its service; pages poll on their cadence via `usePoll`. Extracted from
// mythical-ui (SD13) and EXTENDED with the U7 polling policy (design note §1b-D7, r2-F8):
// per-call interval, ±20% jitter on every delay, exponential ×2 backoff on consecutive failures
