...
export interface ProductSwitcherProps {
  ...
  products?: Product[];
  /** Secondary line of the "command center" (ASGARD) row. Defaults to `ASGARD.role`. Kept as a
   * prop (rather than dropped) so no consumer's value is silently discarded. */
  note?: string;
