...
/**
 * The generic family mark (the branching "M" with petrol nodes). Not the default mark —
 * `Logo` renders the current product's glyph — but exported: it is the fallback for a
